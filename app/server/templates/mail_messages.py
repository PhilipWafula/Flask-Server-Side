...
class MailMessage:
    ...
    def activate_user_mail_message(self):
        ...
        mail_message = f'Thank you for registering an admin account with {self.organization_name}.' \
    ...
    def reset_user_password_mail_message(self):
        ...
        mail_message = f'You requested to reset the password for your {self.organization_name} account.' \
